package com.dev.sallamy.happinessapp.data;
...
import com.dev.sallamy.happinessapp.controler.Controller;
...
public class QuoteData {
    ...
    public void getQuote(final GetAsyncCallBack callBack) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(Request.Method.GET, url , new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray response) {
                ...
                if (null != callBack) callBack.Procesfinished (quoteArrayList);
